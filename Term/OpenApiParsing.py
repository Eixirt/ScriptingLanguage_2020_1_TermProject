...
def getTouristList(Docode, Sigungu):
    ...
    conn.request("GET","/openapi/service/rest/KorService/areaBasedList?ServiceKey=2anybj3QVonkHWCDnuvtKc%2BODpt7fk2eYr7bH49dUkB%2BD%2FzHkoXLVTgiJRJJJReH8sKK4S3vUFPQzNQZhQjbXg%3D%3D&&contentTypeid=15&areaCode="+ str(Docode) +"&sigunguCode=" +str(Sigungu) + "&MobileOS=ETC&MobileApp=AppTesting&numOfRows=30&arrange=A")
